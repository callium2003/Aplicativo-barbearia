...
export default function Agenda() {
  ...
  return <main style={{ minHeight: "100vh", background: "#f6f2ed", color: "#1b1714", fontFamily: "Arial, sans-serif" }}>
    <header style={{ background: "#171310", color: "white", padding: "19px 8vw", display: "flex", justifyContent: "space-between", alignItems: "center" }}><a href="/" style={{ color: "white", textDecoration: "none", fontWeight: 800 }}>BARBEARIA<span style={{ color: "#e99358" }}>SP</span></a><a href="/painel/configurar" style={{ fontSize: 14, color: "#d7ccc0" }}>Configurações</a></header>
    <nav style={{ background: "#2a211c", padding: "12px 8vw", display: "flex", gap: 20, flexWrap: "wrap" }}><a href="/painel/configurar" style={{ color: "#d7ccc0", textDecoration: "none" }}>Dados cadastrais</a><a href="/painel/clientes" style={{ color: "#d7ccc0", textDecoration: "none" }}>Clientes</a><a href="/painel/agenda" style={{ color: "#fff", fontWeight: 700, textDecoration: "none" }}>Agenda</a><a href="/painel/relatorios" style={{ color: "#d7ccc0", textDecoration: "none" }}>Relatórios</a></nav>
